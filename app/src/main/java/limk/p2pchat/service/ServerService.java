...
public class ServerService extends Service {
                ...
                switch (msg.what) {
                    ...
                    case MessageEntity.MessageType.PICTURE_VALUE:
                        ...
                        sendNotification("P2PChat", dbHelper.getUserByUUID(messageEntity.getUUID())
                                .getName() + ": [图片]");
                        break;
                    case MessageEntity.MessageType.VOICE_VALUE:
                        /**
                         * 收到声音消息
                         */
                        ...
                        sendNotification("P2PChat", dbHelper.getUserByUUID(messageEntity.getUUID())
                                .getName() + ": [声音]");
                        break;
                    case MessageEntity.MessageType.VIDEO_VALUE:
                        /**
                         * 收到视频消息
                         */
                        ...
                        Intent intent_8 = new Intent(Constant.OTHER_MESSAGE_INTENT);
                        intent_8.putExtra("messageData", messageEntity.toByteArray());
                    ...
                    case MessageEntity.MessageType.OTHER_VALUE:
                         ...
                         * 收到其他消息
                         */
                        Uri uri_5 = fileManager.createFileCache(messageEntity);

                        messageBuilder = messageEntity.toBuilder();
                        messageBuilder.setMessageHead(uri_5.getPath());
                        messageEntity = messageBuilder.build();

                        dbHelper.insertMessage(messageEntity);
                        sendACKMessage(messageEntity, address);

                        Intent intent_7 = new Intent(Constant.OTHER_MESSAGE_INTENT);
                        intent_7.putExtra("messageData", messageEntity.toByteArray());
                        sendBroadcast(intent_7);
     ...
     * 发送ACK确认消息
     *
     * @param msgEntity : 确认收到的消息
     * @param address   : 要将确认消息发送到的IP地址
     */
